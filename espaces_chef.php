...
<div class="container">
    ...
    <div class="card">
        ...
        <a href="analysechoix_chef.php?quartier=<?php echo urlencode($quartier['Localisation']); ?>">Voir Espaces</a>
    </div>
    <?php endforeach; ?>
</div>
...
<footer>
 <a href="chef_service.php" class="facture-button"> ⬅ Retour</a> &copy; 2025 - Mairie de Bujumbura
</footer>
</body>
</html>