...
$InsertEspaces_verts="insert into espaces_verts (Nom,Localisation,Superficie,Type_espace) values ('$Rec_nom','$Rec_localisation','$Rec_superficie','$Rec_type')";
...
<tr>
    ...
    <td><?php echo $Rec_localisation;?></td>
    <td><?php echo $Rec_superficie;?></td>
    <td><?php echo $Rec_type;?></td>
    <td><a href="Espaces_verts.php?Futa=<?php  ?>" >Supprimer</a></td>
